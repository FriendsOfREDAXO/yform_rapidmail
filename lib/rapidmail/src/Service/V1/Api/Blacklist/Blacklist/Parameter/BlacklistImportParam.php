...
class BlacklistImportParam extends GenericParameter
{
     ...
     *
     * @param BlacklistImportParamFileAttr|array|string|\SplFileInfo $file
     * @return static
     */
    public function setFile($file)
    {

        if ($file instanceof BlacklistImportParamFileAttr) {
